...
function FreeFullPositionPlannerInner() {
  ...
  }, [selectedAsset, direction, stopLoss, allowedMarginLossPercent, tranches[0]?.price, tranches[0]?.margin, tpStages[0]?.roePercent, tpStages[0]?.closePercent])
        ...
        try {
          ...
          if (navigator.canShare({ files: [file] })) {
            await navigator.share({
              files: [file],
              title: `${selectedAsset.symbol} ${direction} Full Trade Plan`,
              text: `Planned via RISKIL Free Full Position Matrix`
            })
